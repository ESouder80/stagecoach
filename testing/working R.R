...
if(USER == "Steve"){
    home = "c:/repos/stagecoach/testing"; setwd(home); 
    Caswell_A <- read_excel("modCaswell_A.xlsx",sheet = 1)
    Caswell_P <- read_excel("modCaswell_P.xlsx")
    Caswell_B <- read_excel("modCaswell_B.xlsx")
    Fission <- read_excel("modCaswell_F.xlsx")
} else {
